...
import { getPostsByTag, getAllTags, type Post } from "@/lib/posts";
          ...
          {!isLoading && posts.length === 0 && (
            <div className="rounded-2xl bg-white p-12 text-center shadow-lg">
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
                ...
                <Link
                  href="/editor"
                  className="inline-block rounded-lg border-2 border-teal-600 bg-white px-6 py-3 font-semibold text-teal-600 transition-all duration-300 hover:bg-teal-50"
                >
                  Create Post
                </Link>
              </div>
